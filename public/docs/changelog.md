...
### 🔧 优化
- 重构了自习模式自定义字体存储机制，将 LocalStorage 升级为 IndexedDB，以支持更大的字体文件并提升加载稳定性。
...
### ✨ 新功能
- 在设置中新增语录刷新间隔的自定义选项，可灵活控制更新频率。
- 根据用户反馈精简在线语录分类：移除「动画、漫画、游戏、原创、来自网络、其他、影视、网易云」，仅保留「文学、诗词、哲学、抖机灵」。
