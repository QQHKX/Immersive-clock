...
### v2.7.0
- ✨ 优化打字机效果：将光标颜色调整为白色，提升视觉对比度
- ⚡ 调整打字机动画速度：减慢打字速度和光标闪烁频率，提供更舒适的阅读体验
- 🌟 新增噪音监测呼吸灯效果：为"安静/吵闹"状态添加动态呼吸灯动画
- 🎨 优化呼吸灯动画：支持五种状态（安静、吵闹、错误、初始化、校准）的不同动画效果
- 🔧 添加状态切换防抖机制：避免噪音监测状态频繁切换，增加1秒延迟以提升稳定性
- 💫 调整呼吸灯频率和幅度：使动画效果更加柔和，减少视觉干扰
